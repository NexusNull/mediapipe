...
#ifndef MEDIAPIPE_CALCULATORS_COMMUNICATION_TCP_SERVER_CALCULATOR_H_
#define MEDIAPIPE_CALCULATORS_COMMUNICATION_TCP_SERVER_CALCULATOR_H_
...
//     }
//   }
class TcpServerCalculator : public NodeIntf {
 public:
  ...
  MEDIAPIPE_NODE_INTERFACE(
    ::mediapipe::AlignHandToPoseInWorldCalculator,
    kInHandLandmarks,
    kInPoseLandmarks,
    kOutHandLandmarks
    );
...
#endif  // MEDIAPIPE_CALCULATORS_COMMUNICATION_TCP_SERVER_CALCULATOR_H_
